...
SENSORS_LIMITS = {
    'sensor.camera.rgb': 10, # default: 4
    'sensor.camera.semantic_segmentation': 10, # added
    'sensor.camera.depth': 10, # added
    'sensor.lidar.ray_cast': 2, # default: 1
    'sensor.lidar.ray_cast_semantic': 1, # added
...
class AgentWrapper(object):
    ...
    allowed_sensors = [
        ...
        'sensor.speedometer',
        'sensor.camera.rgb',
        'sensor.camera.semantic_segmentation', # added
        'sensor.camera.depth', # added
        'sensor.camera',
        'sensor.lidar.ray_cast',
        'sensor.lidar.ray_cast_semantic', # added
        'sensor.other.radar',
        'sensor.other.gnss',
        'sensor.other.imu'
    ]
        ...
        for sensor_spec in self._agent.sensors():
            ...
            # These are the sensors spawned on the carla world
                ...
                if sensor_spec['type'].startswith('sensor.camera.semantic_segmentation'):
                    ...
                    bp.set_attribute('range', str(85))
                    bp.set_attribute('rotation_frequency', str(sensor_spec['rotation_frequency'])) # default: 10
                    bp.set_attribute('channels', str(64))
                    bp.set_attribute('upper_fov', str(10))
                    bp.set_attribute('lower_fov', str(-30))
                    bp.set_attribute('points_per_second', str(600000))
