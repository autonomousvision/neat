...
class MultiTaskImageBDNetwork(nn.Module):
    ''' AIM with BEV semantics
    Args:
    ...
    def __init__(self, config, device, **kwargs):
        super(MultiTaskImageBDNetwork, self).__init__()
        ...
        self.sem_decoder = BroadcastDecoder(config).to(self.device)
